...
void main()
{
    ...
    // this lets the circle expland but the origin of the model
    // is at the base so we need to offset of the len checks
    if (length(fs_in.LocalFragPosition + vec3(0.0, -1.0, 0.0)) > PORTALOPEN)
        discard;
